...
import { FORM_LINK, USDC_LOGO } from "@/lib/utils";
...
const HeroSection = () => {
  ...
  const scrollToWaitlist = () => {
    const waitlistSection = document.getElementById("rate_comp");
    if (waitlistSection) {
    ...
    <section className="relative min-h-screen pt-20 overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 relative z-10 pt-5 md:pt-20 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0 order-2 md:order-1">
          ...
          <h1
            className="text-3xl md:text-5xl lg:text-6xl font-bold font-space leading-tight mb-6 animate-fade-in-up"
            style={{ animationDelay: "0.3s" }}
          >
            Send money to <span className="text-theme-cyan">India</span>{" "}
            instantly with <span className="gradient-text">Google rates</span>{" "}
            and{" "}
          ...
          <p
            className="text-lg text-gray-300 mb-8 max-w-xl animate-fade-in-up"
            style={{ animationDelay: "0.4s" }}
          >
            Experience the fastest way to send money to India with real-time
            exchange rates and absolutely no hidden fees.
          </p>

          <div
            className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start animate-fade-in-up"
          ...
          >
            ...
            <Button
              variant="outline"
              className="border-white/20 bg-white/5 hover:bg-white/10 text-white rounded-xl px-6 py-5 sm:px-8 sm:py-6 text-lg font-medium backdrop-blur-sm"
          ...
          <div
            className="mt-10 flex items-center justify-center md:justify-start animate-fade-in-up"
        ...
        {!isMobile && (
          <div
            className="md:w-1/2 order-1 md:order-2 animate-fade-in"
      ...
      <div
        className="container max-w-7xl mx-auto px-4 sm:px-6 pb-10 animate-fade-in-up"
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="text-center lg:text-left lg:w-1/2">
                ...
                <p className="text-gray-300 mb-6">
                  Get real-time exchange rates and calculate how much your
                  recipient will receive when you send money to India.
                </p>
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                  <div className="bg-theme-dark/70 backdrop-blur-sm border border-white/10 rounded-xl p-4 w-32">
                    <div className="text-xs text-theme-cyan mb-1">
                      USD → INR
                    </div>
                    <div className="text-xl font-semibold font-space">
                      {/*//@ts-ignore*/}
                      {/*//@ts-ignore*/}₹{data ? data.conversion_rate : 83}
                    </div>
                  </div>
                  <div className="bg-theme-dark/70 backdrop-blur-sm border border-white/10 rounded-xl p-4 w-32">
                    <div className="text-xs text-theme-cyan mb-1">
                    ...
                    <div className="text-xl font-semibold font-space">
                      {/*//@ts-ignore*/}
                      {/*//@ts-ignore*/}₹
                      {gbpData ? gbpData.conversion_rate : 104}
                    </div>
                  </div>
                  <div className="bg-theme-dark/70 backdrop-blur-sm border border-white/10 rounded-xl p-4 w-32">
                    <div className="text-xs text-theme-cyan mb-1">
                    ...
                    <div className="text-xl font-semibold font-space">
                      {/*//@ts-ignore*/}
                      {/*//@ts-ignore*/}₹
                      {aedData ? aedData.conversion_rate : 20}
                    </div>
                  </div>
                </div>
              </div>
